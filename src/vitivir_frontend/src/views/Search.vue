  ...
  data() {
    return {
      ...
      taxo:[
        ...
        'Narnaviridae',
        'Partitiviridae',
        'Penicillium spinulosum metavirus 1',
        'Penicillium brevicompactum ssRNA virus 1',
        'Plum pox virus',
        'Pittosporum cryptic virus-1',
        'Potyviridae',
        'Pseudogymnoascus destructants partitivirus-pa',
        'Retro-transcribing viruses',
        'Rhizoctonia solani mitovirus 15',
        'Secoviridae',
        'Scaevola virus A',
        'Shahe picorna-like virus 10',
        'ssRNA viruses',
        'ssDNA viruses',
        'Turnip mosaic virus',
        'Tymoviridae',
